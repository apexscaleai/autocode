...
### Slash Commands (`commands/ac/*.md`)

```yaml
---
name: ac:command-name
...
### Workflows (`autocode/workflows/*.md`)
...
### Templates (`autocode/templates/*.md`)
...
### References (`autocode/references/*.md`)
...
| Commands | `ac:kebab-case` | `/ac:execute-phase` |
...
**Visual patterns:** `autocode/references/ui-brand.md`
