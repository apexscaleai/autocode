# 001: Map dependencies for @commands/ac/new-project.md

## Objective
List **all** files that are loaded/referenced when running the command `@commands/ac/new-project.md` in this repo. The output must be exhaustive and user-facing.

## Context
Repo: `apexscaleai/autocode`.
We need a dependency map for the `@commands/ac/new-project.md` command. This includes any files it directly references and any files referenced transitively by workflows/templates it invokes. The final list should be presented in the SUMMARY.
...
## Process
1. Open `commands/ac/new-project.md` and identify explicit references (workflows, templates, other commands, include directives).
...
## Success Criteria
- [ ] SUMMARY includes a complete list of every file loaded/referenced by `@commands/ac/new-project.md`.
