...
<execution_context>
<!-- Spawns ac-integration-checker agent which has all audit expertise baked in -->
</execution_context>
...
Verify cross-phase wiring and E2E user flows.",
  subagent_type="ac-integration-checker",
...
- /ac:complete-milestone {version} — proceed anyway (accept tech debt)
