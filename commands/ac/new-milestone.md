...
**After this command:** Run `/ac:plan-phase [N]` to start execution.
</objective>

<execution_context>
@~/.claude/autocode/references/questioning.md
@~/.claude/autocode/references/ui-brand.md
@~/.claude/autocode/templates/project.md
@~/.claude/autocode/templates/requirements.md
</execution_context>
...
**Load milestone context (if exists, from /ac:discuss-milestone):**
...
- Check for MILESTONE-CONTEXT.md (from /ac:discuss-milestone)
...
Spawn 4 parallel ac-project-researcher agents with milestone-aware context:
...
Use template: ~/.claude/autocode/templates/research-project/STACK.md
</output>
", subagent_type="ac-project-researcher", model="{researcher_model}", description="Stack research")
...
Use template: ~/.claude/autocode/templates/research-project/FEATURES.md
</output>
", subagent_type="ac-project-researcher", model="{researcher_model}", description="Features research")
...
Use template: ~/.claude/autocode/templates/research-project/ARCHITECTURE.md
</output>
", subagent_type="ac-project-researcher", model="{researcher_model}", description="Architecture research")
...
Use template: ~/.claude/autocode/templates/research-project/PITFALLS.md
</output>
", subagent_type="ac-project-researcher", model="{researcher_model}", description="Pitfalls research")
```
...
Use template: ~/.claude/autocode/templates/research-project/SUMMARY.md
Commit after writing.
</output>
", subagent_type="ac-research-synthesizer", model="{synthesizer_model}", description="Synthesize research")
```

Display research complete banner and key findings:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 AUTOCODE ► RESEARCH COMPLETE ✓
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 AUTOCODE ► DEFINING REQUIREMENTS
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
Spawn ac-roadmapper agent with context:
...
- Re-spawn roadmapper with revision context:
  ...
  ", subagent_type="ac-roadmapper", model="{roadmapper_model}", description="Revise roadmap")
  ```
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 AUTOCODE ► MILESTONE INITIALIZED ✓
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
`/ac:discuss-phase [N]` — gather context and clarify approach
...
**Also available:**
- `/ac:plan-phase [N]` — skip discussion, plan directly
...
- [ ] ac-roadmapper spawned with phase numbering context
- [ ] Roadmap files written immediately (not draft)
- [ ] User feedback incorporated (if any)
- [ ] ROADMAP.md created with phases continuing from previous milestone
- [ ] All commits made (if planning docs committed)
- [ ] User knows next step is `/ac:discuss-phase [N]`
