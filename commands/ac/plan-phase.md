...
**Orchestrator role:** Parse arguments, validate phase, research domain (unless skipped or exists), spawn ac-planner agent, verify plans with ac-plan-checker, iterate until plans pass or max iterations reached, present results.
...
**If not found:** Error - user should run `/ac:new-project` first.
...
<phase_context>
**IMPORTANT:** If CONTEXT.md exists below, it contains user decisions from /ac:discuss-phase.
...
```
Task(
  prompt="First, read ~/.claude/agents/ac-phase-researcher.md for your role and instructions.\n\n" + research_prompt,
...
## 8. Spawn ac-planner Agent

Display stage banner:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 AUTOCODE ► PLANNING PHASE {X}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
IMPORTANT: If phase context exists below, it contains USER DECISIONS from /ac:discuss-phase.
...
<downstream_consumer>
Output consumed by /ac:execute-phase
...
```
Task(
  prompt="First, read ~/.claude/agents/ac-planner.md for your role and instructions.\n\n" + filled_prompt,
  subagent_type="general-purpose",
  model="{planner_model}",
...
## 10. Spawn ac-plan-checker Agent

Display:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 AUTOCODE ► VERIFYING PLANS
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
Spawn ac-planner with revision prompt:
...
- /ac:plan-phase {X} --research — re-research first
...
- [ ] ac-phase-researcher spawned with CONTEXT.md (constrains research scope)
- [ ] Existing plans checked
- [ ] ac-planner spawned with context (CONTEXT.md + RESEARCH.md)
- [ ] Plans created (PLANNING COMPLETE or CHECKPOINT handled)
- [ ] ac-plan-checker spawned with CONTEXT.md (verifies context compliance)
