...
- Example: `/ac:add-phase Add authentication` → description = "Add authentication"
- Example: `/ac:add-phase Fix critical performance issues` → description = "Fix critical performance issues"

If no arguments provided:

```
ERROR: Phase description required
Usage: /ac:add-phase <description>
Example: /ac:add-phase Add authentication system
```
...
2. Insert new phase heading:
   ...
   **Plans:** 0 plans
   ...
   Plans:
   - [ ] TBD (run /ac:plan-phase {N} to break down)
...
**Also available:**
- `/ac:add-phase <description>` — add another phase
- Review roadmap
...
- Don't use decimal numbering (that's /ac:insert-phase)
- Don't create plans yet (that's /ac:plan-phase)
