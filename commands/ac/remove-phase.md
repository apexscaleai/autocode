...
- Example: `/ac:remove-phase 17` → phase = 17
- Example: `/ac:remove-phase 16.1` → phase = 16.1

If no argument provided:

```
ERROR: Phase number required
Usage: /ac:remove-phase <phase-number>
Example: /ac:remove-phase 17
```
...
To abandon current work, use /ac:pause-work instead.
```
...
Would you like to:
- `/ac:progress` — see updated roadmap status
