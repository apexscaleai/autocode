...
│   └── ac/           # AutoCode commands (legacy prefix)
├── autocode/     # Skill resources
...
**New Slash Command:**
- Primary code: `commands/ac/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `autocode/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `autocode/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/autocode/workflows/{name}.md`

**New Reference Document:**
- Implementation: `autocode/references/{name}.md`
