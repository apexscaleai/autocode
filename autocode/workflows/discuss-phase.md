...
1. **ac-phase-researcher** — Reads CONTEXT.md to know WHAT to research
   - "User wants card-based layout" → researcher investigates card component patterns
   - "Infinite scroll decided" → researcher looks into virtualization libraries

2. **ac-planner** — Reads CONTEXT.md to know WHAT decisions are locked
...
Use /ac:progress to see available phases.
```
Exit workflow.
...
**Also available:**
- `/ac:plan-phase ${PHASE} --skip-research` — plan without research
