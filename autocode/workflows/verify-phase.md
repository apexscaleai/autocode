...
<required_reading>
@~/.claude/autocode/references/verification-patterns.md
@~/.claude/autocode/templates/verification-report.md
</required_reading>
...
<!-- Goal-backward derivation expertise is baked into the ac-verifier agent -->
</step>
...
See ~/.claude/autocode/templates/verification-report.md for complete template.
</step>
