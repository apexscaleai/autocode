...
Exit skill and invoke SlashCommand("/ac:plan-phase [X+1]")
...
**Also available:**
- `/ac:discuss-phase [X+1]` — gather context first
- `/ac:research-phase [X+1]` — investigate unknowns
- Review roadmap
...
Exit skill and invoke SlashCommand("/ac:complete-milestone {version}")
