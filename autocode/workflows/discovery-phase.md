...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /ac:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/autocode/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/autocode/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/autocode/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/autocode/templates/discovery.md
...
Use ~/.claude/autocode/templates/discovery.md.
...
1. Discuss phase context (/ac:discuss-phase [current-phase])
2. Create phase plan (/ac:plan-phase [current-phase])
